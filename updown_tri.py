# Sample code credits to: https://github.com/BorisTheBrave/grids
...
def tri_center(a, b, c, edge_length):
...
def tri_line_intersect(x1, y1, x2, y2, edge_length):
...
def tri_rect_intersect(x, y, width, height, edge_length):
